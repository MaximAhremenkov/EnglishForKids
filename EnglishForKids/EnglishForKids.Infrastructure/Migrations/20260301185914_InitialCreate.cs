    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EarnedAchievements", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EarnedAchievements_Achievements_AchievementId",
                        column: x => x.AchievementId,
                        principalTable: "Achievements",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EarnedAchievements_ChildProfiles_ChildProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VirtualPets", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VirtualPets_ChildProfiles_ChildProfileId",
                        column: x => x.ChildProfileId,
                        principalTable: "ChildProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Progresses_ChildProfiles_ChildProfileId",
                        column: x => x.ChildProfileId,
                        principalTable: "ChildProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TestResults_ChildProfiles_ChildProfileId",
                        column: x => x.ChildProfileId,
                        principalTable: "ChildProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsTrueStatement = table.Column<bool>(type: "bit", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Questions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Questions_Rules_RuleId",
                        column: x => x.RuleId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SentenceParts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SentenceParts_Questions_QuestionId",
                        column: x => x.QuestionId,
                        principalTable: "Questions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserAnswers_ChildProfiles_ChildProfileId",
                        column: x => x.ChildProfileId,
                        principalTable: "ChildProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EarnedAchievements_AchievementId",
                table: "EarnedAchievements",
                column: "AchievementId");

            migrationBuilder.CreateIndex(
                name: "IX_EarnedAchievements_ChildProfileId",
                table: "EarnedAchievements",
                column: "ChildProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_Progresses_ChildProfileId",
                table: "Progresses",
                column: "ChildProfileId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Rules_TopicId",
                table: "Rules",
                column: "TopicId");

            migrationBuilder.CreateIndex(
                name: "IX_SentenceParts_QuestionId",
                table: "SentenceParts",
                column: "QuestionId");

            migrationBuilder.CreateIndex(
                name: "IX_TestResults_ChildProfileId",
                table: "TestResults",
                column: "ChildProfileId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserAnswers_ChildProfileId",
                table: "UserAnswers",
                column: "ChildProfileId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VirtualPets_ChildProfileId",
                table: "VirtualPets",
                column: "ChildProfileId",
                unique: true);
        }
